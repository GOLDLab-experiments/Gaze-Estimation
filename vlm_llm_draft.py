...
# processor = AutoProcessor.from_pretrained(PALIGEMMA, use_fast=True)
...
# As it preforms its task, it encounters a person.
# Analyze the person in the image. Consider their facial expression, mood,
# any objects they are holding, their clothes, and the surrounding environment.
# If there are multiple people, refer to the closest one."""

# paligemma_prompt = "<image> Describe the person in the image. Consider their facial expression, mood, any objects they are holding, how they are dressed, and the environment. If there are multiple people, refer to the closest one."
...
# llama_tokenizer = AutoTokenizer.from_pretrained(LLAMA, use_fast=True)
